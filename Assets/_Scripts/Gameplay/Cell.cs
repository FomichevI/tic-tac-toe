...
/// <summary>
/// Класс, реализующий работу одной клетки поля
/// </summary>
// В будущем можно ссылаться на общие настройки игры для определения спрайтов для значков, но это не обязательно, так как, 
// скорее всего, уровень будет строиться из префабов
